...
public class UserDAO implements DAO<User> {
    ...
    private static final String SQL_INSERT = "INSERT INTO utilisateur (email, nom, mot_de_passe, societe, telephone, date_creation, actif, est_admin) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public void create(User user) throws DAOException {
        ...
        try {
            ...
            System.out.println(user.getIs_admin());
