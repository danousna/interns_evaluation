...
public class UserDAO implements DAO<User> {
    ...
    private static final String SQL_SELECT_BY_USER_PASS = "SELECT name, password FROM users WHERE name = ? AND password = ?";
    ...
    public void changeUserActivity(long id) throws DAOException {
        ...
        try {
            /* Récupération d'une connexion depuis la Factory */
            conn = daoFactory.getConnection();
            preparedStatement = initPreparedStatement(conn, SQL_CHANGE_ACTIVITY, true, id);
            int status = preparedStatement.executeUpdate();
    ...
    public boolean validate(String username, String password) {
        ...
        try {
            /* Récupération d'une connexion depuis la Factory */
            conn = daoFactory.getConnection();
            preparedStatement = initPreparedStatement(conn, SQL_SELECT_BY_USER_PASS, true, username, password);
            int status = preparedStatement.executeUpdate();
